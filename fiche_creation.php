<?php
  ...
  if ($action == 'maj') {
    $liste = [
      ...
      'valid'=>'CLIQUER POUR ENREGISTER LA FICHE '
    ];}
  else {
    $liste = [
      'lieu_id'=>"<select name='lieu_id'>".$listeLieux."</select>",
      ...
      'required'=>' required ',
      'datemax'=>$donnees['date_max'],
      'libelle'=>"<input name='libelle' type='text' required value=".$donnees['libelle'].">",
      'date_debut'=>"<input name='date_debut' type='date' value=".$donnees['date_debut'].">",
      'accueil'=>'',
  ...
  <form  enctype="multipart/form-data" method='post' action="fiche_creation.php">
    <table>
      <tbody>
        <tr>
          <th>Référence</th>
          <td><input type='text' required name='reference' value=<?php echo $donnees['reference']?>  ></td><td>Photo : <input name="photo" value=<?php echo $donnees['photo']?>></td>
        </tr>
        <tr>
          <th>Libelle</th>
        ...
        <tr>
          ...
          <td><input type="date" name='date_debut' value=<?php echo $donnees['date_debut'] ?>></td>
        </tr>
        <tr>
          <th>Fabricant</th>
        ...
        <tr>
          <th>Nb elements</th>
          <td><input type="number" name="nb_elements_initial" value=1 min=1></td>
        </tr>
        <tr>
          <th>Facture</th>
      ...
      <tfoot>
        <tr>
          ...
          <td><?php echo $liste['valid']?></td><td></td>
          <td align="right">
            <input type="submit" name="envoyer" value="Enregistrer la fiche"><?php echo $liste['accueil']?>
          </td><td>
